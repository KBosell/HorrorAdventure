...
function changePage(loadPage){
	switch(loadPage){
		...
		case 2: //2-Go Inside
			...
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"5\"> Turn around to leave";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 3: //2-Walk Away
			...
			document.getElementById("buttonA").innerHTML = 
				"";
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"1\" checked> Try Again?";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 4: //3-Keep Going Forward
			document.getElementsByTagName("body")[0].style.backgroundImage = 'url(../_images/Backgrounds/School_Hallway.png)';
			document.getElementById("buttonA").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"6\" checked> Let Mario eat it";
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"7\"> Eat it yourself";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 6: //4-Let Mario Eat The Mushroom
			//document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image.png)';
			document.getElementById("buttonA").innerHTML = 
				"";
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"8\" checked> Continue";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 8: //5-Continue(After Mario)
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				"<input type=\"radio\" name=\"choice\" value=\"9\" checked> Keep Going"
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"10\"> Look in Bathroom";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 9: //6-Keep Going
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				"<input type=\"radio\" name=\"choice\" value=\"11\" checked> Look Inside"
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"12\"> Keep Going";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 10: //6-Look in Bathroom (Death)
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				""
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"8\" checked> Try Again?";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 11: //7-Look Inside
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				"<input type=\"radio\" name=\"choice\" value=\"13\" checked> Open it"
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"14\"> Ignore it";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 13: //8-Open It
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				"<input type=\"radio\" name=\"choice\" value=\"15\" checked> Go upstairs"
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"16\"> Go downstairs";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 15: //9-Go Upstairs
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				"<input type=\"radio\" name=\"choice\" value=\"17\" checked> Face it"
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"18\"> Cower Away";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 16: //9-Go Downstairs (Death)
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				""
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"13\" checked> Try Again?";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 17: //10-Face it
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				"<input type=\"radio\" name=\"choice\" value=\"19\" checked> Go out Window"
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"20\"> Stay in Hallway";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 19: //11-Go out Window(Death)
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				""
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"18\" checked> Try Again?";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 20: //11-Stay in Hallway
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				"<input type=\"radio\" name=\"choice\" value=\"21\" checked> Yell"
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"22\"> Ignore";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 21: //12-Yell
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				"<input type=\"radio\" name=\"choice\" value=\"23\" checked> Try to Attack"
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"24\"> Run Away";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 22: //12-Ignore
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				"<input type=\"radio\" name=\"choice\" value=\"21\" checked> Confront them"
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"24\"> Run Away";
			document.getElementById("title").innerHTML = 
				"";
		...
		case 23: //13-Try to Attack(Death)
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				""
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"21\" checked> Try Again?";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 24: //13-Run Away
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				"<input type=\"radio\" name=\"choice\" value=\"25\" checked> Save yourself?"
			document.getElementById("buttonB").innerHTML = 
				"<input type=\"radio\" name=\"choice\" value=\"26\"> Stay with Amanda";
			document.getElementById("title").innerHTML = 
				"";
			document.getElementById("story").innerHTML = 
		...
		case 26: //14-End-Stay with Amanda
			// document.getElementsByTagName("body")[0].style.backgroundImage = 'url(_css/background_image2.png)';
			document.getElementById("buttonA").innerHTML =
				""
			document.getElementById("buttonB").innerHTML = 
